...
const MENU: MenuItem[] = [
  ...
  { name: "Certifications", children: [{ name: "ISO", href: "/certifications#iso" }, { name: "Uster", href: "/certifications#uster" }] },
...
export default function Navbar() {
  ...
  const backdropUrl = "/mnt/data/12042e70-c6b9-4517-856c-b0e2e0b4313f.png"; // local file path — will be transformed by your toolchain
    ...
    <>
      <header
        className={`fixed inset-x-0 top-0 z-50 transition-all duration-300 backdrop-blur-sm ${
          scrolled ? "bg-white/70 shadow-sm" : "bg-white/95"
        }`}
      >
        <nav ref={navRef} className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center relative">
              ...
              <div
                aria-hidden
                // className="absolute -bottom-1 h-8 px-1 flex items-center pointer-events-none"
              ...
              >
                <span className="block w-full h-8 rounded-full bg-brand-primary/10 backdrop-blur-sm" />
              </div>
